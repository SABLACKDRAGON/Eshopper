                ...
                <table class="table table-condensed">
                    ...
                    <tbody>
                        ...
                        if(file_exists('carritocompras.txt')){
                            ...
                            $total = 0; // Corregido el punto y coma
                ...
                <div class="col-sm-6">
                    <div class="total_area">
                        <ul>
                            ...
                            <li>Impuestos <span><?php echo "$".($total * 0.16); ?></span></li> <!-- Corregido el uso de comillas -->
                            <li>Precio de envio<span>Gratis</span></li>
                            <li>Total <span><?php echo "$".($total + ($total * 0.16)); ?></span></li> <!-- Corregido el uso de comillas -->
                        </ul>
